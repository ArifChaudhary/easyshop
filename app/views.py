...
# Laptop Function View
def laptop(request, data=None):
    if data==None:
        laptops=Product.objects.filter(category='L')
    elif data=='Dell' or data=='Asus' or data=='HP':
...
# Top Wear Function View
def topwear(request, data=None):
    if data==None:
        topwears=Product.objects.filter(category='TW')
    elif data=='Yoyo' or data=='Pee' or data=='Only':
...
# Bottom Wear Function View
def bottomwear(request, data=None):
    if data==None:
        bottomwears=Product.objects.filter(category='BW')
    elif data=='Xoxo' or data=='Loto' or data=='Nike':
